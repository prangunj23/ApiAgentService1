...
Create it as described in the main OCI walkthrough: **VM.Standard.A1.Flex**, 1 OCPU / 6 GB, Ubuntu 24.04, public subnet, your SSH key. That is half the Always Free A1 allowance; ApiAgentService2's VM takes the other half.
...
git clone https://github.com/prangunj23/ApiAgentService1.git /tmp/bootstrap
...
**Out of memory building on 6 GB.** Unlikely for this dependency set, but `sudo fallocate -l 2G /swapfile && sudo chmod 600 /swapfile && sudo mkswap /swapfile && sudo swapon /swapfile` gives headroom.
